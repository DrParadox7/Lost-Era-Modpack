...
recipes.addShaped(<openmodularturrets:hardWallTierTwo>*16, [[<openmodularturrets:hardWallTierOne>, <ExtraUtilities:cobblestone_compressed:2>, <openmodularturrets:hardWallTierOne>], [<ExtraUtilities:cobblestone_compressed:2>, <openmodularturrets:hardWallTierOne>, <ExtraUtilities:cobblestone_compressed:2>], [<openmodularturrets:hardWallTierOne>, <ExtraUtilities:cobblestone_compressed:2>, <openmodularturrets:hardWallTierOne>]]);

recipes.remove(<openmodularturrets:hardWallTierThree>);
recipes.addShaped(<openmodularturrets:hardWallTierThree>*16, [[<openmodularturrets:hardWallTierTwo>, <ExtraUtilities:cobblestone_compressed:3>, <openmodularturrets:hardWallTierTwo>], [<ExtraUtilities:cobblestone_compressed:3>, <openmodularturrets:hardWallTierTwo>, <ExtraUtilities:cobblestone_compressed:3>], [<openmodularturrets:hardWallTierTwo>, <ExtraUtilities:cobblestone_compressed:3>, <openmodularturrets:hardWallTierTwo>]]);

recipes.remove(<openmodularturrets:hardWallTierFour>);
recipes.addShaped(<openmodularturrets:hardWallTierFour>*16, [[<openmodularturrets:hardWallTierThree>, <ExtraUtilities:cobblestone_compressed:4>, <openmodularturrets:hardWallTierThree>], [<ExtraUtilities:cobblestone_compressed:4>, <openmodularturrets:hardWallTierThree>, <ExtraUtilities:cobblestone_compressed:4>], [<openmodularturrets:hardWallTierThree>, <ExtraUtilities:cobblestone_compressed:4>, <openmodularturrets:hardWallTierThree>]]);
