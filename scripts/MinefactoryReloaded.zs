...
recipes.addShaped(<MineFactoryReloaded:machine.0:11>, [[<MineFactoryReloaded:plastic.sheet>, <ThermalExpansion:material:517>, <MineFactoryReloaded:plastic.sheet>], [<ThermalFoundation:material:515>, <ThermalExpansion:Frame>, <ThermalFoundation:material:515>], [<ore:gearLumium>, <ThermalExpansion:material:1>, <ore:gearLumium>]]);
...
recipes.addShaped(<MineFactoryReloaded:machine.1:1>*8, [[<MineFactoryReloaded:plastic.sheet>, <minecraft:chest>, <MineFactoryReloaded:plastic.sheet>], [<ThermalExpansion:material>, <ThermalExpansion:Frame>, <ThermalExpansion:material>], [<MineFactoryReloaded:plastic.sheet>, <ThermalExpansion:material>, <MineFactoryReloaded:plastic.sheet>]]);
recipes.addShaped(<MineFactoryReloaded:machine.1:2>*8, [[<MineFactoryReloaded:plastic.sheet>, <MineFactoryReloaded:cable.plastic>, <MineFactoryReloaded:plastic.sheet>], [<BuildCraft|Factory:tankBlock>, <ThermalExpansion:Frame>, <BuildCraft|Factory:tankBlock>], [<MineFactoryReloaded:plastic.sheet>, <BuildCraft|Factory:tankBlock>, <MineFactoryReloaded:plastic.sheet>]]);
...
recipes.addShaped(<MineFactoryReloaded:machine.2:5>, [[<MineFactoryReloaded:plastic.sheet>, <minecraft:brewing_stand>, <MineFactoryReloaded:plastic.sheet>], [<BuildCraft|Factory:tankBlock>, <ThermalExpansion:Frame>, <BuildCraft|Factory:tankBlock>], [<ore:gearGold>, <ThermalExpansion:material:1>, <ore:gearGold>]]);
...
recipes.addShaped(<MineFactoryReloaded:machine.2:11>, [[<MineFactoryReloaded:plastic.sheet>, <minecraft:iron_bars>, <MineFactoryReloaded:plastic.sheet>], [<ThermalExpansion:Tank:1>, <ThermalExpansion:Frame>, <ThermalExpansion:Tank:1>], [<ore:gearTin>, <ThermalExpansion:material:1>, <ore:gearTin>]]);
...
recipes.addShaped(<MineFactoryReloaded:machine.2:12>, [[<MineFactoryReloaded:plastic.sheet>, <MineFactoryReloaded:plastic.sheet>, <MineFactoryReloaded:plastic.sheet>], [<minecraft:iron_bars>, <MineFactoryReloaded:machine.1:1>, <minecraft:iron_bars>], [<ore:gearInvar>, <MineFactoryReloaded:machine.0:15>, <ore:gearInvar>]]);
