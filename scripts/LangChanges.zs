...
#Name: LangChanges.zs
print("Initializing 'LangChanges.zs'...");
...
#Natura Barley -> Wild Grain
game.setLocalization("en_US", "item.barleyBag.name", "Wild Grain Seed Bag");
game.setLocalization("en_US", "item.barley.seed.name", "Wild Grain Seeds");
game.setLocalization("en_US", "item.barley.plant.name", "Wild Grain");
game.setLocalization("en_US", "item.barley.flour.name", "Wild Grain Flour");

#Tinkers //Convert Aluminum Brass to Gold Solder
game.setLocalization("en_US", "item.tconstruct.Materials.AluBrassIngot.name", "Gold Solder Ingot");
game.setLocalization("en_US", "item.tconstruct.Materials.AluBrassNugget.name", "Gold Solder Nugget");
game.setLocalization("en_US", "item.tconstruct.Materials.AluBrassDust.name", "Gold Solder Dust");
game.setLocalization("en_US", "StorageMetals.AlBrass.name", "Block of Gold Solder");

game.setLocalization("en_US", "tile.fluid.molten.alubrass.name", "Molten Gold Solder");
game.setLocalization("en_US", "LiquidMetal.AluBrass.name", "Molten Gold Solder");
game.setLocalization("en_US", "fluid.aluminumbrass.molten", "Molten Gold Solder");
game.setLocalization("en_US", "item.tconstruct.bucket.AluBrass.name", "Molten Gold Solder Bucket");
game.setLocalization("en_US", "item.iguana.tcon.clayBucket.AluBrass.name", "Molten Gold Solder Clay Bucket");

#Rename Thermal Foundation metals to their legitimate names
...
print("Initialized 'LangChanges.zs'");
